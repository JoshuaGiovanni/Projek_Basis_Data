...
<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-gray-400 mt-1">Performance metrics and insights</p>
        </div>
        
        <form action="{{ route('analytics.dashboard') }}" method="GET" class="flex flex-wrap items-end gap-3 bg-[#1e293b] p-3 rounded-lg border border-white/5">
            <div>
                <label for="start_date" class="block text-xs font-medium text-gray-400 mb-1">Start Date</label>
                <input type="date" name="start_date" id="start_date" value="{{ $startDate }}" 
                    class="bg-[#0f172a] border border-white/10 rounded px-3 py-1.5 text-sm text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none">
            </div>
            <div>
                <label for="end_date" class="block text-xs font-medium text-gray-400 mb-1">End Date</label>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-[#1e293b] rounded-xl border border-white/5 p-6 shadow-xl">
            <h3 class="text-lg font-semibold text-white mb-4">Most Profitable Services</h3>
        ...
        <div class="bg-[#1e293b] rounded-xl border border-white/5 p-6 shadow-xl">
            <h3 class="text-lg font-semibold text-white mb-4">Profit by Age & Client Type</h3>
            <div class="relative h-64 w-full">
    ...
    <div class="bg-[#1e293b] rounded-xl border border-white/5 p-6 shadow-xl">
        <h3 class="text-lg font-semibold text-white mb-4">Analyst Performance by Experience</h3>
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="text-gray-400 border-b border-white/10 text-xs uppercase tracking-wider">
                ...
                <tbody class="text-sm divide-y divide-white/5">
                    ...
                    <tr class="hover:bg-white/5 transition-colors group">
                        ...
                        <td class="py-3 px-4 text-right text-green-400 font-mono">
